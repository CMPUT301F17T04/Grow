...
public class ActivityMainTest10 {
    ...
    public void activityMainTest10() {
        ...
        ViewInteraction appCompatEditText3 = onView(
                allOf(withId(R.id.dialog_edit_id), withText("fufu"),
                        childAtPosition(
                                ...
                                0),
                        isDisplayed()));
        appCompatEditText3.perform(replaceText("fufuu"));

        ViewInteraction appCompatEditText4 = onView(
                allOf(withId(R.id.dialog_edit_id), withText("fufuu"),
                        childAtPosition(
                                childAtPosition(
                                        withId(R.id.custom),
                                        0),
        ...
        ViewInteraction appCompatEditText5 = onView(
                allOf(withId(R.id.dialog_edit_id), withText("fufuu"),
                        childAtPosition(
                                ...
                                0),
                        isDisplayed()));
        appCompatEditText5.perform(replaceText("fufu"));
        ...
        ViewInteraction appCompatImageButton = onView(
                allOf(withId(R.id.toolbar_btn_follow),
                        childAtPosition(
        ...
        ViewInteraction appCompatTextView = onView(
                allOf(withId(android.R.id.title), withText("Search Users"),
                        childAtPosition(
                                childAtPosition(
