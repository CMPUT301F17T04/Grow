...
public class Testing {
    ...
    public void testing1() {
        ...
        Espresso.onView(ViewMatchers.withId(R.id.navigation_event)).perform(ViewActions.click());
        Espresso.onView(ViewMatchers.withId(R.id.navigation_habit)).perform(ViewActions.click());
